...
public class ActivitySplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create loading to wait for few second before displaying ActivityVideo
        new Loading().execute();
    }
    ...
    public class Loading extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            // When progress finished, open ActivityVideo
            Intent homeIntent = new Intent(getApplicationContext(), ActivityVideo.class);
